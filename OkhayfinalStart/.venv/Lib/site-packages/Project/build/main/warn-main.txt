...
missing module named pyimod02_importers - imported by E:\4th semester\DBMS\SemesterProject(Clinical System)\akhirKar\OkhayfinalStart\.venv\Lib\site-packages\PyInstaller\hooks\rthooks\pyi_rth_pkgutil.py (delayed), E:\4th semester\DBMS\SemesterProject(Clinical System)\akhirKar\OkhayfinalStart\.venv\Lib\site-packages\PyInstaller\hooks\rthooks\pyi_rth_pkgres.py (delayed)
...
missing module named _typeshed - imported by numpy.random.bit_generator (top-level), setuptools._distutils.dist (conditional), pkg_resources (conditional), setuptools.glob (conditional), setuptools.compat.py311 (conditional)
